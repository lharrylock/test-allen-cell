...
After running `npm run develop`, go to http://localhost:8000/___graphql

In the query editor, copy the following and press the play button to see the results:
...
query CustomPage($id: String!) {
  ...
  {
    "id": "/home/lisah/git/test-allen-cell/src/pages/custom-pages/2018-06-19-test2.md absPath of file >>> MarkdownRemark"
  }
